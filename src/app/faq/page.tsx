...
// Schema injected via layout since "use client" — inject in a separate server wrapper
// For this client component page, we output the JSON-LD via a script tag in the return
const faqSchema = {
