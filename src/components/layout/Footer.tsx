...
// ─── Social placeholder links (replace hrefs when accounts are live) ──────────
const SOCIALS = [
  {
    label: "X (Twitter)",
    href: "https://twitter.com/iptvuksubscription",
    Icon: () => (
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/iptvuksubscription",
    Icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden>
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/iptvuksubscription",
    Icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden>
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@iptvuksubscription",
    Icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden>
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@iptvuksubscription",
    Icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden>
      ...
      <div className="mx-auto max-w-7xl px-6 py-14 lg:py-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            >
              <div className="h-8 w-8 rounded-full bg-[rgba(255,255,255,0.10)] border border-[rgba(255,255,255,0.18)] flex items-center justify-center">
                <span className="font-heading text-xs text-white leading-none select-none">UK</span>
              </div>
              <div className="flex flex-col leading-none">
                <span className="font-heading text-lg tracking-widest text-[#F2F2F7]">IPTV UK</span>
            ...
            <div className="mt-5 flex items-center gap-2 flex-wrap">
              {SOCIALS.map(({ label, href, Icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-8 h-8 flex items-center justify-center rounded-lg border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] text-[#6E6E7A] hover:text-[#F2F2F7] hover:bg-[rgba(255,255,255,0.09)] hover:border-[rgba(255,255,255,0.15)] transition-all duration-200"
                >
                  <Icon />
                </a>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-[rgba(255,255,255,0.06)] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/privacy-policy" className="text-xs text-[#6E6E7A] hover:text-[#F2F2F7] transition-colors">
              Privacy
            </Link>
            <Link href="/terms" className="text-xs text-[#6E6E7A] hover:text-[#F2F2F7] transition-colors">
              Terms
            </Link>
            <Link href="/refund-policy" className="text-xs text-[#6E6E7A] hover:text-[#F2F2F7] transition-colors">
              Refunds
            </Link>
          </div>
        </div>
